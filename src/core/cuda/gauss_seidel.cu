      ...
      int largestnumperrow)
{
   ...
   if(NUM_BLOCKS > 65535)
      std::cout << "Block number larger than 65535!!" << std::endl;
   ...
   {
      std::cout << "preRRRFullCsr num_per_row is equal or larger than 221!!" << std::endl;
      exit(0);
   }
      ...
      bool verbose)
{
   ...
   if (verbose) {
      std::cout << "In preRRRFullSymmetric : ";
   ...
   {
      std::cout << "largest block size is larger than shared size!!!" << std::endl;
      exit(0);
   }
   ...
   {
      std::cout << "preRRRFullSymmetric num_entries_per_thread is larger than 90!!" << std::endl;
      exit(0);
   }
      ...
      int largestnumentries)
{
   ...
   else
   {
      ...
      std::cout << "preRRRFullSymmetricSync num_entries_per_thread is larger than 70!!" << std::endl;
      exit(0);
   }
      ...
      int largestblksize)
{
   ...
   {
      std::cout << "preRRRFull num_per_row is equal or larger than 221!!" << std::endl;
      exit(0);
   }
   cudaThreadSetCacheConfig(cudaFuncCachePreferL1);
      ...
      int largestnumentries)
{
   ...
   for(int i = 0; i < post_relaxes; i++)
   {
      ...
      {
         std::cout << "In posePCRFull num_per_row larger than 90!!" << std::endl;
         exit(0);
      }
      x.swap(xout);
      ...
      int largestnumentries)
{
   ...
   for(int i = 0; i < post_relaxes; i++)
   {
      ...
      {
         std::cout << "In posePCRFullSymmetricSync num_per_row larger than 70!!" << std::endl;
         exit(0);
      }
      ...
      int largestblksize)
{
   ...
   for(int i = 0; i < post_relaxes; i++)
   {
      ...
      {
         std::cout << "In posePCRFull num_per_row equal or larger than 221!!" << std::endl;
         exit(0);
      }
