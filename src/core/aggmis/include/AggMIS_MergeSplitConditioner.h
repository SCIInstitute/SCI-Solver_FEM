...
//                __device__ T Reduce(int size, T* input, T* scratch, )
        ...
        public:
            ...
            */            
            MergeSplitConditionerGPU(Graph_d &graph, 
            ...
            void PrintSizeStats(ostream* output,
                    bool makeHeader);
            void PrintMemoryStats(ostream* output,
                    bool makeHeader);
